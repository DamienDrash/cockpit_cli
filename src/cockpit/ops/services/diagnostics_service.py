...
from cockpit.ops.models.diagnostics import (
...
class OperationsDiagnosticsService:
    ...
    def docker_diagnostics(self) -> list[dict[str, object]]:
        ...
        for detail in details:
            ...
            diag = DockerContainerDiagnostics(
                ...
                last_incident_status=incident.status.value
    ...
    def datasource_diagnostics(self) -> list[dict[str, object]]:
        ...
        for record in recent_failures:
            ...
            if subject not in last_failure_message and isinstance(
        ...
        for row in decisions:
            ...
            if (
                ...
                and subject_ref
                and subject_ref not in last_guard
            ):
    ...
    def overview(self) -> dict[str, object]:
        return {
            ...
            "recent_guard_decisions": self._guard_decision_repository.list_recent(
                limit=20
            ),
            "recent_operations": [
                record.to_dict()
