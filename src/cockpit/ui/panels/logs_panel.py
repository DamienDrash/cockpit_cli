...
from cockpit.workspace.services.activity_log_service import (
    ActivityLogRecord,
    ActivityLogService,
)
...
class LogsPanel(BasePanel):
    ...
    def compose(self) -> ComposeResult:
        with Horizontal():
            ...
            with Vertical(id="logs-main"):
                ...
                yield Static(
                    "Select an event to see raw payload.",
                    id="logs-detail-view",
                    classes="detail-view",
                )
    ...
    def _render_grid(self) -> None:
        try:
            ...
            for entry in self._entries:
                ...
                if not entry.success and not entry.status:
                    status_style = "yellow"
    ...
    def _update_detail(self, entry: ActivityLogRecord) -> None:
        ...
        detail_text.append(
            f"Recorded: {entry.recorded_at.isoformat()}\n\n", style="cyan"
        )
