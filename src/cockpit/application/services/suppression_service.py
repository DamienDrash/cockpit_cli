...
from cockpit.domain.events.notification_events import SuppressionRuleChanged
from cockpit.domain.models.notifications import NotificationCandidate, NotificationSuppressionRule
...
class SuppressionService:
    ...
    def list_rules(self, *, enabled_only: bool = False) -> list[NotificationSuppressionRule]:
        return self._repository.list_all(enabled_only=enabled_only)

    def save_rule(self, rule: NotificationSuppressionRule) -> NotificationSuppressionRule:
    ...
    @staticmethod
    def _matches(candidate: NotificationCandidate, rule: NotificationSuppressionRule) -> bool:
