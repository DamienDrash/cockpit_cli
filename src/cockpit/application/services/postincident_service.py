...
class PostIncidentService:
    ...
    def ensure_review(
        ...
        *,
        ...
        existing = self._review_repository.get_for_incident(incident_id)
    ...
    def get_review_detail_for_incident(self, incident_id: str) -> PostIncidentReviewDetail | None:
        review = self._review_repository.get_for_incident(incident_id)
        if review is None:
            return None
